...
def main():
    ...
    p.add_argument("--recircle", nargs='?', const='true', default=None, help="SoftBD recircle switch (true/false)")
    p.add_argument("--softbd_enable", nargs='?', const='true', default=None, help="SoftBD master switch (true/false)")
    ...
    p.add_argument(
        ...
        const='true',
        default=None,
        help="Override cleanup_intermediate_files in configuration (true/false)",
    )
    p.add_argument(
        "--batch_id",
        default=None,
        help="Batch subdirectory name; `Timestamp-random code` is automatically generated by default to avoid overwriting by running the same seed multiple times.",
    )
